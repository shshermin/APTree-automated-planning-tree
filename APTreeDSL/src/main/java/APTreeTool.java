...
import CoCos.PlanningService.ProblemDomainMatchCoCo;
  ...
  public void run(String modelFile) {
    ...
    try {
       ...
       // checker.addCoCo(planningServiceCheck);
        ...
        // New: Problem-Domain consistency check
        ProblemDomainMatchCoCo problemDomainCheck = new ProblemDomainMatchCoCo();
        checker.addCoCo((PlanningServiceASTPlannerENHSPCoCo) problemDomainCheck);
