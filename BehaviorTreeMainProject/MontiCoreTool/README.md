# MontiCoreTool - Behavior Tree DSL
...
The following custom tasks are defined for the MontiCoreTool:
...
**Solution**: Ensure you're in the `MontiCoreTool` directory where `gradlew.bat` (Windows) or `gradlew` (Unix/Linux) exists.
