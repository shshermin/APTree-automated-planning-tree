...
namespace ModelLoader.ParameterTypes
{
    public class Stick : Element
    {
        ...
        public Stick(Location initLoc, Location finalLoc) : this()
        {
        ...
        public Stick(string name, Location initLoc, Location finalLoc) : base(name)
        {
            this.InitLoc = initLoc;
            this.FinalLoc = finalLoc;
            BaseType = new FastName("Element");
        ...
        // Override SetParameters to set Stick-specific properties
