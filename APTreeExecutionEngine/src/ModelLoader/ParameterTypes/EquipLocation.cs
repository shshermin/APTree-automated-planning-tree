...
namespace ModelLoader.ParameterTypes
{
    public class EquipLocation : Location
    {
        ...
        public EquipLocation(Coordinate position, Coordinate orientation) : this()
        {
        ...
        public EquipLocation(string name, Coordinate position, Coordinate orientation) : base(name)
        {
            this.Position = position;
            this.Orientation = orientation;
            BaseType = new FastName("Location");
        ...
        // Override SetParameters to set EquipLocation-specific properties
