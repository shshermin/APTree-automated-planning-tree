...
namespace ModelLoader.ParameterTypes
{
    public class InitialLocation : Location
    {
        ...
        public InitialLocation(Coordinate position, Coordinate orientation) : this()
        {
        ...
        public InitialLocation(string name, Coordinate position, Coordinate orientation) : base(name)
        {
            this.Position = position;
            this.Orientation = orientation;
            BaseType = new FastName("Location");
        ...
        // Override SetParameters to set InitialLocation-specific properties
