    ...
    public class FullTreeTest
    {
        ...
        private async Task CreateCassetteBehaviorTree(Blackboard<FastName> blackboard)
        {
            try
            {
                ...
                var pddlRequest1 = new PDDLPlanningRequest("./Plannerinputs/static/DomainHL.pddl", "./Plannerinputs/static/problemC1.pddl", "/home/ubuntu/jpddlplus-master/jpddlplus.jar", "ENHSP");
                var pddlRequest2 = new PDDLPlanningRequest("./Plannerinputs/static/DomainHL.pddl", "./Plannerinputs/static/problemC2.pddl", "/home/ubuntu/jpddlplus-master/jpddlplus.jar", "ENHSP");
                var pddlRequest3 = new PDDLPlanningRequest("./Plannerinputs/static/DomainHL.pddl", "./Plannerinputs/static/problemC3.pddl", "/home/ubuntu/jpddlplus-master/jpddlplus.jar", "ENHSP");
                var pddlRequest4 = new PDDLPlanningRequest("./Plannerinputs/static/DomainHL.pddl", "./Plannerinputs/static/problemC4.pddl", "/home/ubuntu/jpddlplus-master/jpddlplus.jar", "ENHSP");
