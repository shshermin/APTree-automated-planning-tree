...
(positionfree initloccube9)
(atplace cube9 finloccube9)
(accessible cube9)
(stacked cube9 stick37)
(stacked cube9 stick38)
...
(not (accessible stick39))
(not (accessible stick38))
    ) 
  )
)